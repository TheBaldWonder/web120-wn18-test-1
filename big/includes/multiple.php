...
#EDIT THE FOLLOWING:
$toAddress = "jonathan.d.heilman@seattlecentral.edu";  //place your/your client's email address here
$toName = "Jonathan Heilman"; //place your client's name here
$website = "JonathanHeilman-Web120";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Get a Quote" tabindex="40" /> Get a Quote <br />
			<input type="checkbox" name="Interested_In[]" value="Website Redesign" /> Website Design <br />
			<input type="checkbox" name="Interested_In[]" value="Custom Applications" /> Custom Applications <br />
			<input type="checkbox" name="Interested_In[]" value="Info on Upcoming MeetUp" /> Info on Upcoming MeetUp <br />
